...
// Trending items — Google Books thumbnail URLs (reliable CDN)
const TRENDING_BOOKS = [
  { title:"Atomic Habits",           author:"James Clear",      genre:"Self-Help", emoji:"⛛️",
    cover:"https://books.google.com/books/content?id=XfFvDwAAQBAJ&printsec=frontcover&img=1&zoom=2&source=gbs_api" },
  { title:"Fourth Wing",             author:"Rebecca Yarros",   genre:"Fantasy",   emoji:"🐉",
    cover:"https://books.google.com/books/content?id=vFekEAAAQBAJ&printsec=frontcover&img=1&zoom=2&source=gbs_api" },
  { title:"The Housemaid",           author:"Freida McFadden",  genre:"Thriller",  emoji:"🔪",
    cover:"https://books.google.com/books/content?id=3rNJEAAAQBAJ&printsec=frontcover&img=1&zoom=2&source=gbs_api" },
  { title:"It Ends with Us",         author:"Colleen Hoover",   genre:"Romance",   emoji:"🌸",
    cover:"https://books.google.com/books/content?id=68GcCwAAQBAJ&printsec=frontcover&img=1&zoom=2&source=gbs_api" },
  { title:"A Court of Thorns and Roses", author:"Sarah J. Maas", genre:"Fantasy",  emoji:"🌹",
    cover:"https://books.google.com/books/content?id=E6W9BQAAQBAJ&printsec=frontcover&img=1&zoom=2&source=gbs_api" },
];

const TRENDING_MANGA = [
  { title:"One Piece",               author:"Eiichiro Oda",     genre:"Manga",     emoji:"🏴‍☠️",
    cover:"https://books.google.com/books/content?id=iFtqDwAAQBAJ&printsec=frontcover&img=1&zoom=2&source=gbs_api" },
  { title:"Jujutsu Kaisen",          author:"Gege Akutami",     genre:"Manga",     emoji:"👁️",
    cover:"https://books.google.com/books/content?id=Uo0HEAAAQBAJ&printsec=frontcover&img=1&zoom=2&source=gbs_api" },
  { title:"Berserk",                 author:"Kentaro Miura",    genre:"Manga",     emoji:"⚔️",
    cover:"https://books.google.com/books/content?id=K6xmDwAAQBAJ&printsec=frontcover&img=1&zoom=2&source=gbs_api" },
  { title:"Chainsaw Man",            author:"Tatsuki Fujimoto", genre:"Manga",     emoji:"🪴",
    cover:"https://books.google.com/books/content?id=NHkkEAAAQBAJ&printsec=frontcover&img=1&zoom=2&source=gbs_api" },
  { title:"Demon Slayer",            author:"Koyoharu Gotouge", genre:"Manga",     emoji:"🌊",
    cover:"https://books.google.com/books/content?id=EtqoDwAAQBAJ&printsec=frontcover&img=1&zoom=2&source=gbs_api" },
];
